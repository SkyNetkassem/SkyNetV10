...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (infoSelect) {
    infoSelect.addEventListener("change", function () {
      ...
      const map = {
        "٣٠٠٠": { bg: "card2.png", duration: "٣٠ يوم", comment: "3000", limit: "limit-bytes-total=12300M limit-uptime=30d" },
        "٥٠٠": { bg: "card16.png", duration: "١٠ يوم", comment: "500", limit: "limit-bytes-total=2148M limit-uptime=7d" },
        "١٠٠٠": { bg: "card9.png", duration: "١٥ يوم", comment: "1000", limit: "limit-bytes-total=4296M limit-uptime=15d" },
        "١٦٠٠": { bg: "card3.png", duration: "٢٠ يوم", comment: "1600", limit: "limit-bytes-total=5144M limit-uptime=20d" },
        "٢٠٠٠": { bg: "card1.png", duration: "٢٥ يوم", comment: "2000", limit: "limit-bytes-total=8292M limit-uptime=25d" }
      };
